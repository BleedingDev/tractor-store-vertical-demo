...
Generated apps and verticals use `npm:@bleedingdev/...@3.8.2-ultramodern.9` aliases for the Modern.js packages published under the UltraModern `latest` dist-tag.

To migrate an older generated app onto the strict Effect/HttpApi topology and package cohort:

```bash
pnpm migrate:strict-effect -- --version 3.8.2-ultramodern.9
```
