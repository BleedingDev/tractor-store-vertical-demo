...
Generated apps and verticals use `npm:@bleedingdev/...@3.5.0-ultramodern.103` aliases for the Modern.js packages that are part of the UltraModern canary line.

To migrate an older generated app onto the strict Effect/HttpApi topology and package cohort:

```bash
pnpm migrate:strict-effect -- --version 3.5.0-ultramodern.103
```
