...
```text
3.9.0-ultramodern.14
```

Generated apps and verticals use `npm:@bleedingdev/...@3.9.0-ultramodern.14` aliases for the Modern.js packages published under the UltraModern `latest` dist-tag.
