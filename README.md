...
Generated apps and verticals use `npm:@bleedingdev/...@3.9.0-ultramodern.8` aliases for the Modern.js packages published under the UltraModern `latest` dist-tag.
