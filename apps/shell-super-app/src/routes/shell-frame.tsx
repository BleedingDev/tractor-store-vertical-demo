...
export default function ShellFrame({ boundary = 'explore', children, showCart = true }: ShellFrameProps) {
  ...
  return (
    <main className="shell:min-h-screen shell:bg-um-canvas shell:px-4 shell:py-5 shell:text-um-foreground shell:sm:px-6 shell:lg:px-12" data-mf-page-boundary={boundary}>
