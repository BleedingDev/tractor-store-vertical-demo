...
const workspaceValidationContract = {
  ...
  cohort: {
    ...
    releaseCohort: {
      aliases: {
        ...
        '@modern-js/plugin-styled-components':
          '@bleedingdev/modern-js-plugin-styled-components',
        ...
        '@modern-js/server-runtime-extensions':
          '@bleedingdev/modern-js-server-runtime-extensions',
      ...
      schemaVersion: 1,
      source: {
        commit: 'ccb24fc94710cc8c4818b5af64df4a66b6445562',
        repository: 'BleedingDev/ultramodern.js',
      },
    },
    appIds: ['shell-super-app', 'explore', 'decide', 'checkout'],
    backendAppIds: ['explore', 'decide', 'checkout'],
    verticalIds: ['explore', 'decide', 'checkout'],
    ...
    packageManifests: [
      {
        id: 'workspace-root',
        packageName: 'tractor-store-vertical-demo',
        path: 'package.json',
        role: 'workspace-root',
      },
      {
      ...
      },
      {
        ...
        path: 'verticals/explore/package.json',
        role: 'vertical',
      },
      {
        id: 'decide',
        packageName: '@tractor-store-vertical-demo/decide',
        path: 'verticals/decide/package.json',
        role: 'vertical',
      },
      {
        id: 'checkout',
        packageName: '@tractor-store-vertical-demo/checkout',
        path: 'verticals/checkout/package.json',
        role: 'vertical',
      },
      {
        id: 'shared-contracts',
        packageName: '@tractor-store-vertical-demo/shared-contracts',
        path: 'packages/shared-contracts/package.json',
        role: 'shared-package',
      },
      {
        id: 'shared-design-tokens',
        packageName: '@tractor-store-vertical-demo/shared-design-tokens',
  ...
  topology: {
      ...
      apps: [
        {
          id: 'shell-super-app',
          kind: 'shell',
          package: '@tractor-store-vertical-demo/shell-super-app',
          ...
          deploy: {
            cloudflare: {
              distributedSsrProofRoutes: ['/en', '/en/tractors/CL-08-GR'],
              jsonSmokeChecks: [
                {
                  id: 'tractor-domain-explore-cl-08-gr',
                ...
                {
                  id: 'tractor-domain-decide-cl-08-gr',
                ...
                {
                  id: 'tractor-domain-checkout-cl-08-gr',
                  method: 'POST',
                  ...
                  expect: {
                    'item.sku': 'CL-08-GR',
                    'item.name': 'Holland Hamster Polder Green',
                    'item.price': 7750,
                    'item.quantity': 2,
        ...
        },
        {
          ...
          api: {
            ...
            stem: 'explore',
            prefix: '/explore-api',
            consumedBy: ['shell-super-app', 'explore'],
            serverEntry: 'verticals/explore/api/index.ts',
          },
          backendFederation: {
            ...
            exposes: {
              './effect-api': {
                contract: 'verticals/explore/shared/api.ts',
                runtime: 'verticals/explore/api/index.ts',
                client: 'verticals/explore/src/api/explore-client.ts',
                openapi: '/explore-api/openapi.json',
                readiness: '/explore-api/explore/readiness',
              },
            },
            versionBoundary: {
              ...
              ui: {
                ...
                manifestUrl: 'http://localhost:3021/mf-manifest.json',
                buildMarker:
                  'verticals/explore/src/routes/ultramodern-route-metadata.ts',
              },
              api: {
                readiness: '/explore-api/explore/readiness',
                buildMarker: 'verticals/explore/shared/ultramodern-build.ts',
            ...
            executionSurfaces: {
              cloudflare: {
                ...
                zephyr: {
                  ...
                  snapshotIdEnv: 'ZEPHYR_EXPLORE_SNAPSHOT_ID',
                  versionIdEnv: 'ZEPHYR_EXPLORE_VERSION_ID',
                  applicationUidEnv: 'ZEPHYR_EXPLORE_APPLICATION_UID',
                },
                workerDispatch: {
                  preferred: 'service-binding',
                  serviceBinding: 'VERTICAL_EXPLORE_WORKER',
                  serviceBindingEnv: 'VERTICAL_EXPLORE_WORKER_BINDING',
                  dispatchNamespaceEnv: 'VERTICAL_EXPLORE_DISPATCH_NAMESPACE',
                  dispatchWorkerNameEnv: 'VERTICAL_EXPLORE_WORKER_NAME',
        ...
        },
        {
          id: 'decide',
          kind: 'vertical',
          package: '@tractor-store-vertical-demo/decide',
          ...
          api: {
            ...
            stem: 'decide',
            prefix: '/decide-api',
            consumedBy: ['shell-super-app', 'decide'],
            serverEntry: 'verticals/decide/api/index.ts',
          },
          backendFederation: {
            role: 'microvertical-server',
            ...
            exposes: {
              './effect-api': {
                contract: 'verticals/decide/shared/api.ts',
                runtime: 'verticals/decide/api/index.ts',
                client: 'verticals/decide/src/api/decide-client.ts',
                openapi: '/decide-api/openapi.json',
                readiness: '/decide-api/decide/readiness',
              },
            },
            versionBoundary: {
              invariant: 'web-and-api-same-build',
              ...
              ui: {
                ...
                manifestUrl: 'http://localhost:3022/mf-manifest.json',
                buildMarker:
                  'verticals/decide/src/routes/ultramodern-route-metadata.ts',
              },
              api: {
                readiness: '/decide-api/decide/readiness',
                buildMarker: 'verticals/decide/shared/ultramodern-build.ts',
            ...
            executionSurfaces: {
              cloudflare: {
                ...
                zephyr: {
                  runtime: 'ssr-worker',
                  integration: 'managed-cloudflare',
                  snapshotIdEnv: 'ZEPHYR_DECIDE_SNAPSHOT_ID',
                  versionIdEnv: 'ZEPHYR_DECIDE_VERSION_ID',
                  applicationUidEnv: 'ZEPHYR_DECIDE_APPLICATION_UID',
                },
                workerDispatch: {
                  preferred: 'service-binding',
                  serviceBinding: 'VERTICAL_DECIDE_WORKER',
                  serviceBindingEnv: 'VERTICAL_DECIDE_WORKER_BINDING',
                  dispatchNamespaceEnv: 'VERTICAL_DECIDE_DISPATCH_NAMESPACE',
                  dispatchWorkerNameEnv: 'VERTICAL_DECIDE_WORKER_NAME',
                  requestInterface: 'fetch',
                },
              },
              node: {
        ...
        },
        {
          id: 'checkout',
          kind: 'vertical',
          package: '@tractor-store-vertical-demo/checkout',
          ...
          api: {
            ...
            serverEntry: 'verticals/checkout/api/index.ts',
          },
          backendFederation: {
            role: 'microvertical-server',
            ...
            exposes: {
              './effect-api': {
                contract: 'verticals/checkout/shared/api.ts',
                runtime: 'verticals/checkout/api/index.ts',
                client: 'verticals/checkout/src/api/checkout-client.ts',
                openapi: '/checkout-api/openapi.json',
                readiness: '/checkout-api/checkout/readiness',
              },
            },
            versionBoundary: {
              invariant: 'web-and-api-same-build',
              ...
              ui: {
                ...
                manifestUrl: 'http://localhost:3023/mf-manifest.json',
                buildMarker:
                  'verticals/checkout/src/routes/ultramodern-route-metadata.ts',
              },
              api: {
                readiness: '/checkout-api/checkout/readiness',
                buildMarker: 'verticals/checkout/shared/ultramodern-build.ts',
            ...
            executionSurfaces: {
              cloudflare: {
                ...
                zephyr: {
                  runtime: 'ssr-worker',
                  integration: 'managed-cloudflare',
                  snapshotIdEnv: 'ZEPHYR_CHECKOUT_SNAPSHOT_ID',
                  versionIdEnv: 'ZEPHYR_CHECKOUT_VERSION_ID',
                  applicationUidEnv: 'ZEPHYR_CHECKOUT_APPLICATION_UID',
                },
                workerDispatch: {
                  preferred: 'service-binding',
                  serviceBinding: 'VERTICAL_CHECKOUT_WORKER',
                  serviceBindingEnv: 'VERTICAL_CHECKOUT_WORKER_BINDING',
                  dispatchNamespaceEnv: 'VERTICAL_CHECKOUT_DISPATCH_NAMESPACE',
                  dispatchWorkerNameEnv: 'VERTICAL_CHECKOUT_WORKER_NAME',
                  requestInterface: 'fetch',
                },
              },
              node: {
    ...
    referenceTopology: {
      ...
      shell: {
        ...
        cloudflare: {
          target: 'cloudflare',
          workerName: 'tractor-store-vertical-demo-shell-super-app',
      ...
      verticals: [
        {
          ...
          api: {
            ...
            contract: {
              export: './api',
              path: 'verticals/explore/shared/api.ts',
            },
            client: {
              export: './api/client',
              path: 'verticals/explore/src/api/explore-client.ts',
            },
            serverEntry: 'verticals/explore/api/index.ts',
            basePath: '/explore-api/explore',
            consumedBy: ['shell-super-app', 'explore'],
            readiness: {
              endpoint: '/explore/readiness',
              marker: {
          ...
          cloudflare: {
            ...
            routes: {
              ssr: '/en',
              mfManifest: '/mf-manifest.json',
              locale: '/locales/en/explore.json',
              apiReadiness: '/explore-api/explore/readiness',
            },
            security: {
              enabled: true,
              headers: {
          ...
          ownership: {
            ...
            slack: '#super-app-platform',
            pagerDuty: 'pd-super-app-platform',
            runbookRef: 'runbooks/verticals/explore.md',
            adrRef: 'docs/super-app-rfc-adr/verticals.md#explore',
            blastRadius: {
              tier: 'tier-2-vertical',
              references: ['docs/super-app-rfc-adr/blast-radius.md#explore'],
            },
          },
        },
        {
          ...
          api: {
            ...
            contract: {
              export: './api',
              path: 'verticals/decide/shared/api.ts',
            },
            client: {
              export: './api/client',
              path: 'verticals/decide/src/api/decide-client.ts',
            },
            serverEntry: 'verticals/decide/api/index.ts',
            basePath: '/decide-api/decide',
            consumedBy: ['shell-super-app', 'decide'],
            readiness: {
              endpoint: '/decide/readiness',
              marker: {
                ui: 'ultramodernUiMarker',
                api: 'ultramodernApiMarker',
                skew: 'none',
          ...
          cloudflare: {
            ...
            routes: {
              ssr: '/en',
              mfManifest: '/mf-manifest.json',
              locale: '/locales/en/decide.json',
              apiReadiness: '/decide-api/decide/readiness',
            },
            security: {
              enabled: true,
              headers: {
            ...
            jsonSmokeChecks: [
              {
                id: 'decide-readiness-smoke',
                route: '/decide-api/decide/readiness',
                expect: {
                  status: 'ready',
                  'checks.api': 'ready',
                  'checks.moduleFederation': 'ready',
          ...
          ownership: {
            ...
            slack: '#super-app-platform',
            pagerDuty: 'pd-super-app-platform',
            runbookRef: 'runbooks/verticals/decide.md',
            adrRef: 'docs/super-app-rfc-adr/verticals.md#decide',
            blastRadius: {
              tier: 'tier-2-vertical',
              references: ['docs/super-app-rfc-adr/blast-radius.md#decide'],
            },
          },
        },
        {
          ...
          api: {
            ...
            contract: {
              export: './api',
              path: 'verticals/checkout/shared/api.ts',
            },
            client: {
              export: './api/client',
              path: 'verticals/checkout/src/api/checkout-client.ts',
            },
            serverEntry: 'verticals/checkout/api/index.ts',
            basePath: '/checkout-api/checkout',
            consumedBy: ['shell-super-app', 'checkout'],
            readiness: {
              endpoint: '/checkout/readiness',
              marker: {
                ui: 'ultramodernUiMarker',
                api: 'ultramodernApiMarker',
                skew: 'none',
          ...
          cloudflare: {
            ...
            routes: {
              ...
              apiReadiness: '/checkout-api/checkout/readiness',
            },
            security: {
              enabled: true,
              headers: {
            ...
            jsonSmokeChecks: [
              {
                id: 'checkout-readiness-smoke',
                route: '/checkout-api/checkout/readiness',
                expect: {
                  status: 'ready',
                  'checks.api': 'ready',
                  'checks.moduleFederation': 'ready',
          ...
          ownership: {
            ...
            slack: '#super-app-platform',
            pagerDuty: 'pd-super-app-platform',
            runbookRef: 'runbooks/verticals/checkout.md',
            adrRef: 'docs/super-app-rfc-adr/verticals.md#checkout',
            blastRadius: {
              tier: 'tier-2-vertical',
              references: ['docs/super-app-rfc-adr/blast-radius.md#checkout'],
            },
          },
        },
      ],
      sharedPackages: [
        {
          id: 'shared-contracts',
          package: '@tractor-store-vertical-demo/shared-contracts',
          path: 'packages/shared-contracts',
          description: 'Generated route, ownership, and topology contracts.',
        },
        {
          id: 'shared-design-tokens',
          package: '@tractor-store-vertical-demo/shared-design-tokens',
          path: 'packages/shared-design-tokens',
          description:
            'Generated design tokens consumed by shell and verticals.',
        },
      ],
      validation: {
      ...
      owners: [
        ...
        },
        {
          ...
          ownership: {
            ...
            adrRef:
              'docs/super-app-rfc-adr/wave2/reference-topology.md#explore',
            blastRadius: {
        ...
        },
        {
          ...
          ownership: {
            ...
            adrRef:
              'docs/super-app-rfc-adr/wave2/reference-topology.md#checkout',
            blastRadius: {
    ...
    developmentOverlay: {
      ...
      manifests: {
        explore: 'http://localhost:3021/mf-manifest.json',
  ...
  validationEvidencePolicy: {
    ...
    required: [
      ...
      {
        id: 'executable-modern-config',
        kind: 'runtime',
      },
      {
        id: 'executable-runtime-config',
        kind: 'runtime',
      },
      {
        id: 'executable-module-federation-config',
        kind: 'runtime',
      },
      {
        id: 'executable-build-facade',
        kind: 'runtime',
      },
      {
        id: 'structured-package-config',
        kind: 'structured',
      },
      {
        id: 'structured-deploy-config',
        kind: 'structured',
      },
      {
        id: 'public-behavior-gates',
        kind: 'behavior',
      },
    ],
  },
  ...
  fullStackVerticals: [
    {
      ...
      apiClientPath: 'src/api/explore-client.ts',
      backendFederation: {
        contractVersion: 'microvertical-server-effect-v1',
        deliveryUnit: {
          schemaVersion: 1,
      ...
      namespace: 'explore',
      routePagePaths: [],
      routeMetaPaths: ['verticals/explore/src/routes/[lang]/route.meta.ts'],
      localisedUrls: {},
      verticalRefs: [],
    },
    {
      ...
      apiClientExport: './api/client',
      apiContractPath: 'shared/api.ts',
      apiClientPath: 'src/api/decide-client.ts',
      backendFederation: {
        contractVersion: 'microvertical-server-effect-v1',
        deliveryUnit: {
          schemaVersion: 1,
      ...
      namespace: 'decide',
      routePagePaths: [],
      routeMetaPaths: ['verticals/decide/src/routes/[lang]/route.meta.ts'],
      localisedUrls: {},
      verticalRefs: ['explore', 'checkout'],
    },
    {
      ...
      apiClientExport: './api/client',
      apiContractPath: 'shared/api.ts',
      apiClientPath: 'src/api/checkout-client.ts',
      backendFederation: {
        contractVersion: 'microvertical-server-effect-v1',
        deliveryUnit: {
          schemaVersion: 1,
      ...
      namespace: 'checkout',
      routePagePaths: [],
      routeMetaPaths: ['verticals/checkout/src/routes/[lang]/route.meta.ts'],
      localisedUrls: {},
      verticalRefs: [],
    },
  ],
...
const runtimeModuleReferences = (sourceFile) => {
  ...
  const visit = (node) => {
    if (
      ...
      record(node, node.moduleSpecifier.text, 'static-import', node.isTypeOnly);
    } else if (
...
const isWorkspaceSourceSpecifier = (specifier) => {
  ...
  return (
    segments.length > 3 && segments[0].startsWith('@') && segments[2] === 'src'
  );
};
...
const jsxAttribute = (attributes, name) =>
  attributes.properties.find(
    (property) =>
      typescript.isJsxAttribute(property) && nodeName(property.name) === name
  );
...
const assertCompilerArchitecture = () => {
  ...
  if (compilerSnapshot === undefined) {
    ...
    assert(
      packageJson.scripts?.check
        ?.split('&&')
        .some((stage) => stage.trim() === 'pnpm typecheck'),
  ...
  for (const absolutePath of checkedFiles) {
    ...
    const visit = (node) => {
      ...
      if (typescript.isIdentifier(node) && node.text === 'ULTRAMODERN_ZEPHYR') {
        compilerFailure(
          sourceFile,
          node,
...
const createStylingContract = (app) => {
  const sharedTokenPackage = packageNameFor(
    packageScope,
    'shared-design-tokens'
  );
  const ownedLayers =
...
const tsgoCacheKey = (packagePath) =>
...
const assertPublicHeadContract = (appId, publicHead) => {
  ...
  assert(
    publicHead?.structuredData?.helperModule ===
      './src/routes/ultramodern-jsonld',
...
const expectedWorkerName = (packageSuffix) =>
...
assert(
  activeMiseTools.node?.some(
    (tool) => tool.requested_version === expectedNodeVersion
  ),
...
const assertAdditionalShellCohort = () => {
  ...
  if (!hasDeliveryUnits) {
    ...
    for (const shell of expectedAdditionalShells) {
      ...
      assert(
        zeropsYaml.includes(
          `        ${shell.portEnv}: ${quoteYamlString(String(shell.port))}`
        ),
...
if (hasDeliveryUnits) {
  const zeropsYaml = readText('zerops.yaml');
  assert(
    zeropsYaml.includes('zerops:'),
    'Zerops manifest must include zerops services'
  );
  assert(
    zeropsYaml.includes(`setup: ${quoteYamlString('shell-super-app')}`),
...
assert(
  rootPackage.scripts?.['migrate:strict-effect'] ===
...
assert(
  generatedContract.cssFederation?.sharedDesignTokens?.owner?.id ===
    'shared-design-tokens',
  'CSS federation must declare shared design token ownership'
);
assert(
  generatedContract.cssFederation?.sharedDesignTokens?.role ===
    'shared-design-tokens',
...
assert(
  generatedContract.cssFederation?.sharedDesignTokens?.assets?.exports?.includes(
    './tokens.css'
  ),
  'Shared design tokens must export their CSS asset'
);
assert(
  generatedContract.cssFederation?.sharedDesignTokens?.dedupe
    ?.duplicateBaseStylesAllowed === false,
  'Shared design token CSS must be deduplicated'
);
assert(
  generatedContract.cssFederation?.sharedDesignTokens?.ssr
    ?.firstPaintRequired === true,
...
assert(
  sameJson(
    shellContract?.deploy?.cloudflare?.security,
...
assert(
  shellContract?.deploy?.worker?.compatibilityDate ===
    expectedCloudflareCompatibilityDate,
...
assert(
  shellContract?.config?.performance?.readinessDiagnostics?.default ===
    'enabled',
  'Shell performance readiness diagnostics must be default-on'
);
assert(
  shellContract?.config?.performance?.readinessDiagnostics?.failOn ===
    'framework-invariant',
...
assert(
  shellContract?.moduleFederation?.dts?.tsConfigPath ===
...
assert(
  shellContract?.styling?.federation?.rootSelector ===
...
assert(
  shellContract?.styling?.federation?.layers?.owned?.includes(
...
assert(
  shellContract?.styling?.federation?.entrypoints?.css?.includes(
...
assert(
  shellContract?.styling?.federation?.dedupe?.duplicateBaseStylesAllowed ===
    false,
...
assert(
  shellContract?.routes?.privateByDefault === true,
  'Shell routes must be private by default'
);
assert(
...
assertPublicSurfaceContract(
  'shell-super-app',
  shellContract?.routes?.publicSurface
);
assert(
...
assertPublicSurfaceAssets(
  'apps/shell-super-app',
  shellContract?.routes?.publicRoutes ?? []
);
assert(
...
for (const vertical of fullStackVerticals) {
  ...
  if (vertical.emitsApi) {
    ...
    if (vertical.apiProtocol === 'rpc') {
      assert(
        !fs.existsSync(
          path.join(root, `${vertical.path}/src/api/${vertical.stem}-client.ts`)
        ),
  ...
  assert(
    contractEntry?.kind === 'vertical',
    `${vertical.id} generated contract kind is incorrect`
  );
  assert(
    contractEntry?.deploy?.cloudflare?.workerName ===
      expectedWorkerName(vertical.id),
  ...
  assert(
    contractEntry?.deploy?.cloudflare?.compatibilityDate ===
      expectedCloudflareCompatibilityDate,
  ...
  assert(
    sameJson(
      contractEntry?.deploy?.cloudflare?.security,
      expectedCloudflareSecurity
    ),
  ...
  assertCloudflareQualityGates(
    vertical.id,
    contractEntry?.deploy?.cloudflare?.qualityGates
  );
  assert(
    contractEntry?.deploy?.worker?.compatibilityDate ===
      expectedCloudflareCompatibilityDate,
  ...
  assert(
    contractEntry?.config?.performance?.readinessDiagnostics?.default ===
      'enabled',
  ...
  assert(
    sameJson(
      contractEntry?.moduleFederation?.verticalRefs ?? [],
      vertical.verticalRefs
    ),
  ...
  assert(
    sameJson(
      (contractEntry?.moduleFederation?.remotes ?? []).map(
        (remote) => remote.id
      ),
      vertical.verticalRefs
    ),
  ...
  if (vertical.emitsApi) {
    ...
    assert(
      contractEntry?.api?.group === vertical.group,
      `${vertical.id} API group is incorrect`
    );
    assert(
      contractEntry?.api?.runtime === 'effect',
      `${vertical.id} API runtime must be Effect`
    );
    assert(
    ...
    if (vertical.apiProtocol === 'rpc') {
      ...
      assert(
        contractEntry?.api?.readiness?.endpoint ===
          `/${vertical.stem}/readiness`,
        `${vertical.id} readiness endpoint is incorrect`
      );
      assert(
        contractEntry?.api?.operations?.readiness?.path ===
          `/${vertical.stem}/readiness`,
        `${vertical.id} readiness operation is missing`
      );
      assert(
        contractEntry?.api?.requestContext?.propagatedHeaders?.includes(
          'traceparent'
        ),
  ...
  assert(
    JSON.stringify(contractEntry?.i18n?.localisedUrls) ===
      JSON.stringify(vertical.localisedUrls),
  ...
  assert(
    contractEntry?.routes?.metadataExport ===
      './src/routes/ultramodern-route-metadata',
  ...
  if (vertical.emitsUi) {
    ...
    assertPublicSurfaceContract(
      vertical.id,
      contractEntry?.routes?.publicSurface
    );
    assert(
    ...
    assertPublicSurfaceAssets(
      vertical.path,
      contractEntry?.routes?.publicRoutes ?? []
    );
  }
  ...
  if (vertical.emitsUi) {
    ...
    assert(
      contractEntry?.styling?.federation?.rootSelector ===
        `[data-app-id="${vertical.id}"]`,
      `${vertical.id} CSS root selector is incorrect`
    );
    assert(
      contractEntry?.styling?.federation?.classPrefix ===
        `${vertical.tailwindPrefix}:`,
    ...
    assert(
      contractEntry?.styling?.federation?.dedupe?.runtimeLoad ===
        'once-per-content-hash',
      `${vertical.id} CSS dedupe strategy is incorrect`
    );
    assert(
      contractEntry?.styling?.federation?.ssr?.verticalCss ===
        'federated-manifest-owned-css',
  ...
  assert(
    ownership.owners?.some(
      (owner) => owner.id === vertical.id && owner.path === vertical.path
    ),
