...
const workspaceValidationContract = {
  ...
  cohort: {
    ...
    releaseCohort: {
      ...
      schemaVersion: 1,
      source: {
        commit: '4772a4f48686764f954e429011998fd72364a0b7',
          ...
          backendFederation: {
            ...
            versionBoundary: {
              ...
              ui: {
                manifestEnv: 'VERTICAL_EXPLORE_MF_MANIFEST',
                manifestUrl: 'http://localhost:3021/mf-manifest.json',
                buildMarker: 'verticals/explore/src/routes/ultramodern-route-metadata.ts',
              },
              api: {
                readiness: '/explore-api/explore/readiness',
          ...
          backendFederation: {
            ...
            versionBoundary: {
              ...
              ui: {
                manifestEnv: 'VERTICAL_DECIDE_MF_MANIFEST',
                manifestUrl: 'http://localhost:3022/mf-manifest.json',
                buildMarker: 'verticals/decide/src/routes/ultramodern-route-metadata.ts',
              },
              api: {
                readiness: '/decide-api/decide/readiness',
          ...
          backendFederation: {
            ...
            versionBoundary: {
              ...
              ui: {
                manifestEnv: 'VERTICAL_CHECKOUT_MF_MANIFEST',
                manifestUrl: 'http://localhost:3023/mf-manifest.json',
                buildMarker: 'verticals/checkout/src/routes/ultramodern-route-metadata.ts',
              },
              api: {
                readiness: '/checkout-api/checkout/readiness',
    ...
    rules: [
      {
        ...
        paths: [
          ...
          {
            kind: 'directory',
            path: 'verticals/explore/src',
            extensions: ['.ts', '.tsx'],
          },
          {
            kind: 'directory',
            path: 'verticals/explore/api',
            extensions: ['.ts', '.tsx'],
          },
          {
            kind: 'directory',
            path: 'verticals/decide/src',
            extensions: ['.ts', '.tsx'],
          },
          {
            kind: 'directory',
            path: 'verticals/decide/api',
            extensions: ['.ts', '.tsx'],
          },
          {
            kind: 'directory',
            path: 'verticals/checkout/src',
            extensions: ['.ts', '.tsx'],
          },
          {
            kind: 'directory',
            path: 'verticals/checkout/api',
            extensions: ['.ts', '.tsx'],
          },
          {
            kind: 'directory',
          ...
          {
            kind: 'file',
            path: 'verticals/explore/modern.config.ts',
          },
          {
            kind: 'file',
            path: 'verticals/decide/modern.config.ts',
          },
          {
            kind: 'file',
            path: 'verticals/checkout/modern.config.ts',
          },
          {
            kind: 'file',
          ...
          {
            kind: 'file',
            path: 'verticals/explore/module-federation.config.ts',
          },
          {
            kind: 'file',
            path: 'verticals/decide/module-federation.config.ts',
          },
          {
            kind: 'file',
            path: 'verticals/checkout/module-federation.config.ts',
          },
        ],
        patterns: [
          {
...
assert(
  [`'effect@${expectedEffectVersion}'`, `effect@${expectedEffectVersion}`].some((effectPatchKey) =>
    pnpmWorkspace.includes(`${effectPatchKey}: patches/effect-schema-error-type-id.patch`),
  ),
