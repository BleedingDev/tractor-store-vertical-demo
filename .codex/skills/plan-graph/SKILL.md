...
7. Inspect what already exists before minting new work.
...
8. Preserve exact targeting across subagents.
...
9. Persist or reuse the shared snapshot when the graph will feed other skills.
