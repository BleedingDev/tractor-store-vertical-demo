...
export default function ExploreHome() {
  ...
  useEffect(() => {
    void fetch('/explore-api/effect/explore?limit=1', {
      headers: {
  ...
  return (
    <main className="explore:min-h-screen explore:bg-um-canvas explore:px-4 explore:py-6 explore:text-um-foreground explore:sm:px-8">
      ...
      <p className="explore:mt-3 explore:text-lg explore:text-stone-600" data-mf-role="vertical">{t('explore.role')}</p>
      <p className="explore:sr-only" data-build-marker={ultramodernUiMarker.build} data-testid="ultramodern-ui-marker">
