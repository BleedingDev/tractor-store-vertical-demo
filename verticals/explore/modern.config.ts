...
const port = Number(getBuildConfigEnvironment('VERTICAL_EXPLORE_PORT') ?? 3021);
  ...
  presetUltramodern(
    {
      ...
      tools: {
        ...
        bundlerChain: (chain) => {
          chain.output
            .uniqueName('verticalExplore')
            .chunkLoadingGlobal('__ULTRAMODERN_VERTICAL_EXPLORE_LOADED_CHUNKS__');
        },
        devServer: {
          headers: {
