...
export function listCheckout(
  ...
  return runEffectRequest(
    ...
    runEffectRequest(
      client.checkout.list({ query: { limit: options.limit } }),
    ),
  );
}
...
export function getCheckoutReadiness(
  ...
  return runEffectRequest(
    ...
    runEffectRequest(client.checkout.readiness({})),
  );
}
...
export function getCheckout(
  ...
  return runEffectRequest(
    ...
    runEffectRequest(client.checkout.get({ params: { id } })),
  );
}
...
export function createCheckout(
  ...
  return runEffectRequest(
    ...
    runEffectRequest(
      client.checkout.create({ payload: { title } }),
    ),
  );
}
